...
// ----------------------------------------------------------------------------
std::array<RefPointP1::Vec_T, RefPointP1::numFuns> const RefPointP1::points = {
    {Vec_T::Constant(1.L)}};

std::array<ScalarFun<1>, RefPointP1::numFuns> const RefPointP1::phiFun = {{
    [](Vec_T const &) { return 1.L; },
}};

std::array<onedFun_T, RefPointP1::numFuns> const RefPointP1::dphiFun = {
    {[](Vec_T const &) { return Vec_T::Constant(0.L); }}};

std::array<onedFun_T, RefPointP1::numGeoFuns> const RefPointP1::mapping =
    RefPointP1::dphiFun;

// ----------------------------------------------------------------------------
Vec1 const RefLineP0::refMidpoint = Vec1{0.};

std::array<RefLineP0::Vec_T, RefLineP0::numFuns> const RefLineP0::points = {
    {Vec_T::Constant(0.L)}};

std::array<ScalarFun<1>, RefLineP0::numFuns> const RefLineP0::phiFun = {{
    [](Vec_T const &) { return 1.L; },
}};
...
std::array<ScalarFun<1>, RefLineP1::numFuns> const RefLineP1::phiFun = {
...
std::array<onedFun_T, RefLineP1::numFuns * RefLineP1::dim> const RefLineP1::d2phiFun = {
    {[](Vec_T const &) { return Vec_T::Constant(0.L); },
     [](Vec_T const &) { return Vec_T::Constant(0.L); }}};
...
std::array<ScalarFun<1>, RefLineP2::numFuns> const RefLineP2::phiFun = {
...
std::array<onedFun_T, RefLineP2::numFuns * RefLineP2::dim> const RefLineP2::d2phiFun = {
...
std::array<twodFun_T, RefTriangleP1::numGeoFuns> const RefTriangleP1::mapping =
...
std::array<twodFun_T, RefTriangleP2::numGeoFuns> const RefTriangleP2::mapping =
    RefTriangleP2::dphiFun;

// ----------------------------------------------------------------------------
Vec2 const RefTriangleP0::refMidpoint = Vec2{1. / 3, 1. / 3};

std::array<scalarTwodFun_T, RefTriangleP0::numFuns> const RefTriangleP0::phiFun = {
    {[](Vec_T const &) { return 1.; }}};

std::array<twodFun_T, RefTriangleP0::numFuns> const RefTriangleP0::dphiFun = {
    {[](Vec_T const &) { return Vec_T::Constant(0.); }}};

// linear mapping
std::array<twodFun_T, RefTriangleP0::numGeoFuns> const RefTriangleP0::mapping =
    RefTriangleP1::mapping;

// ----------------------------------------------------------------------------
Vec2 const RefTriangleRT0::refMidpoint = Vec2{1. / 3, 1. / 3};

std::array<twodFun_T, RefTriangleRT0::numFuns> const RefTriangleRT0::phiVectFun = {{
...
std::array<scalarTwodFun_T, RefQuadP2::numFuns> const RefQuadP2::phiFun = {
    {[](Vec_T const & p)
...
std::array<twodFun_T, RefQuadP2::numFuns> const RefQuadP2::dphiFun = {
    {[](Vec_T const & p)
     {
       return Vec_T(
...
std::array<scalarTwodFun_T, RefQuadP0::numFuns> const RefQuadP0::phiFun = {
    {[](Vec_T const &) { return 1.; }}};

std::array<twodFun_T, RefQuadP0::numFuns> const RefQuadP0::dphiFun = {
    {[](Vec_T const &) { return Vec_T::Constant(0.); }}};
...
std::array<twodFun_T, RefQuadRT0::numFuns> const RefQuadRT0::phiVectFun = {{
...
std::array<scalarTwodFun_T, RefQuadRT0::numFuns> const RefQuadRT0::divphiFun = {{
...
std::array<threedFun_T, RefTetrahedronP1::numGeoFuns> const RefTetrahedronP1::mapping =
...
std::array<threedFun_T, RefTetrahedronP2::numGeoFuns> const RefTetrahedronP2::mapping =
...
// linear mapping
std::array<threedFun_T, RefTetrahedronP0::numGeoFuns> const RefTetrahedronP0::mapping =
    RefTetrahedronP1::mapping;
...
std::array<threedFun_T, RefHexahedronQ1::numFuns> const RefHexahedronQ1::dphiFun = {{
    [](Vec_T const & p)
    {
      return Vec_T(
...
std::array<threedFun_T, RefHexahedronQ1::numGeoFuns> const RefHexahedronQ1::mapping =
...
std::array<threedFun_T, RefHexahedronQ2::numFuns> const RefHexahedronQ2::dphiFun = {{
    [](Vec_T const & p)
    {
      return Vec_T(
...
std::array<threedFun_T, RefHexahedronQ2::numGeoFuns> const RefHexahedronQ2::mapping =
...
// tri-linear mapping
std::array<threedFun_T, RefHexahedronP0::numGeoFuns> const RefHexahedronP0::mapping =
...
// tri-linear mapping
std::array<threedFun_T, RefHexahedronRT0::numGeoFuns> const RefHexahedronRT0::mapping =
    RefHexahedronQ1::mapping;
